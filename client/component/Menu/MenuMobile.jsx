        ...
        <div className="menu-mobile__menu">
          ...
          <div className="menu-mobile__menu--content">
            ...
            <div className="menu-mobile__footer">
              <div>
                <img src="/img/rviewlogo.png" className="menu-mobile__logo" />
              </div>
              ...
              <div>
                <a className="rview-link--mobile" href="https://reviewbase.org">reviewbase.org</a>
              </div>
              <div className="menu-mobile__footer--copyright">&copy; Copyright 2019 ReviewBase Technology Group. All Rights Reserved</div>
            </div>
          </div>
